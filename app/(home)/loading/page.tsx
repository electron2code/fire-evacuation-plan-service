            ...
            <div className="relative z-10 flex flex-col items-center justify-center">
                <div className="relative">
                    ...
                    <div className="relative p-6 rounded-full animate-bounce-slow">
                        ...
                        <h1 className="text-gray-800 text-center text-base font-bold">Evacuation <span className="bg-orange-500 bg-clip-text text-transparent">Plan</span> <br /> Service</h1>
                    </div>
                </div>
