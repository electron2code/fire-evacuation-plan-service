    ...
    return (
        <div className="flex flex-wrap items-center gap-14 md:gap-3">
            <div className="w-full relative max-w-md px-4 shadow-[0_0_0_rgba(210, 210, 210, 0.5)] border border-gray-300 rounded">
                <div className="absolute left-1/2 -translate-x-1/2 -top-10 w-16 h-16 rounded-full bg-orange-600 flex items-center justify-center">
                ...
                <div className="flex items-center gap-5 justify-start px-4 mt-4 pt-5">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-black">MD. Sabbir Hossain</h3>
                        <p className="text-sm text-black leading-6">Please send a whatsapp message</p>
                    </div>
                </div>
                <div className="py-5 px-4">
                    <Link className="inline-block text-center bg-orange-600 text-gray-50 font-bold px-5 py-2 rounded w-full" href="https://wa.me/+8801601770053">Whatsapp me</Link>
                </div>
            </div>
            <div className="w-full relative max-w-md px-4 shadow-[0_0_0_rgba(210, 210, 210, 0.5)] border border-gray-300 rounded">
                ...
                <div className="flex items-center gap-5 justify-start px-4 mt-4 pt-5">
                    ...
                    <div className="w-full">
                        <h3 className="text-xl font-bold text-black">MD. Sabbir Hossain</h3>
                        <p className="text-sm wrap-normal text-black leading-6">Please send the message "Ask a question"</p>
                    </div>
                </div>
                <div className="py-5 px-4">
                    <Link className="inline-block text-center bg-orange-600 text-gray-50 font-bold px-5 py-2 rounded w-full" href="mailto:evacuationplanservice@gmail.com">Email me</Link>
                </div>
            </div>
        </div>
    )
