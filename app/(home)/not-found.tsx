...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-8 py-3 bg-linear-to-r from-orange-500 to-red-600 text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300"
                    >
                    ...
                    <button
                        ...
                        className="px-8 py-3 bg-white text-gray-900 font-semibold rounded-lg border-2 border-gray-300 hover:border-orange-500 hover:shadow-lg transition-all duration-300"
                    >
                        Go Back
                    </button>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-300">
                    ...
                    <div className="flex justify-center gap-6">
                        <a href="/" className="text-orange-600 hover:text-orange-700 font-medium transition-colors">Help Center</a>
                        <span className="text-gray-300">•</span>
                        <a href="/" className="text-orange-600 hover:text-orange-700 font-medium transition-colors">Support</a>
                        <span className="text-gray-300">•</span>
                        <a href="/" className="text-orange-600 hover:text-orange-700 font-medium transition-colors">Contact</a>
                    </div>
                </div>
            </div>
        </div>
