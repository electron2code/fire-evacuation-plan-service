            ...
            <div className="w-full max-w-7xl mx-auto py-16 px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="flex flex-col justify-center space-y-4 gap-3">
                        <Image className='rounded-2xl border border-gray-500/50' alt='I-will-design-for-fire-emergency-exit-and-fire-evacuation-plan-claim-assistance' src="/I-will-design-for-fire-emergency-exit-and-fire-evacuation-plan.jpeg" width={592} height={546} />
                    </div>
